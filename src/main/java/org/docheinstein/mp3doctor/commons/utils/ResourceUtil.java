...
public class ResourceUtil {
    ...
    public static URL getAssetURL(Class clazz, String resource) {
        return getResourceURL(clazz, Config.Paths.Resources.ASSETS + resource);
    }
    ...
    public static URL getAssetURL(String resource) {
        return getResourceURL(Config.Paths.Resources.ASSETS + resource);
    }
    ...
    public static URL getStyleURL(Class clazz, String resource) {
        return getResourceURL(clazz, Config.Paths.Resources.CSS + resource);
    }
    ...
    public static URL getStyleURL(String resource) {
        return getResourceURL(Config.Paths.Resources.CSS + resource);
    }
    ...
    public static URL getImageURL(Class clazz, String resource) {
        return getResourceURL(clazz, Config.Paths.Resources.IMAGES + resource);
    }
    ...
    public static URL getImageURL(String resource) {
        return getResourceURL(Config.Paths.Resources.IMAGES + resource);
    }
    ...
    public static InputStream getImageStream(Class clazz, String resource) {
        return getResourceStream(clazz, Config.Paths.Resources.IMAGES + resource);
    }
    ...
    public static InputStream getImageStream(String resource) {
        return getResourceStream(Config.Paths.Resources.IMAGES + resource);
    }
}
